...
original = original.drop(['CRASH_DATE', 'CRASH_TIME'], axis=1)
...
savefig('../data/images/NYC_collisions_balance.png')
...
df_under.to_csv('../data/NYC_collisions_undersampling.csv', index=False)
...
df_over.to_csv('../data/NYC_collisons_oversampling.csv', index=False)
...
df_smote.to_csv('../data/NYC_collisions_SMOTEsampling.csv', index=False)
