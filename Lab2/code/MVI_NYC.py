...
#For Contributing factors too many mvs and different values so just fill and then remove feature
df.loc[df['CONTRIBUTING_FACTOR_1'].isna(), 'CONTRIBUTING_FACTOR_1'] = nan_constant_fill
df.loc[df['CONTRIBUTING_FACTOR_2'].isna(), 'CONTRIBUTING_FACTOR_2'] = nan_constant_fill
